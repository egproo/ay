          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($location['jpos_location_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $location['jpos_location_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $location['jpos_location_id']; ?>" />
                    <?php } ?></td>
