        ...
        <fieldset>
          ...
          <div class="well">
            <div class="input-group" style="width: 100%">
              ...
              <span class="input-group-addon hide"><i class="fa fa-filter"></i> <?php echo $text_filter; ?></span>
            </div>
          </div>
        </fieldset>
        <div id="jpos-extension"></div>
      </div>
    </div>
  </div>
  <?php if ($categories) { ?>
...
$('#jpos-extension').on('click', '.btn-success', function(e) {
	e.preventDefault();
...
$('#jpos-extension').on('click', '.btn-danger, .btn-warning', function(e) {
	e.preventDefault();
