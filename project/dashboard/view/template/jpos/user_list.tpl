          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($user['jpos_user_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $user['jpos_user_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $user['jpos_user_id']; ?>" />
                    <?php } ?></td>
