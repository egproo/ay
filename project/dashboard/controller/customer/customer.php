...
class ControllerCustomerCustomer extends Controller {
	...
	protected function validateForm() {
		...
		$customer_info = $this->model_customer_customer->getCustomerByEmailOrPhone($this->request->post['email']);
		$customer_info2 = $this->model_customer_customer->getCustomerByEmailOrPhone($this->request->post['telephone']);



		if (!isset($this->request->get['customer_id'])) {
			if ($customer_info || $customer_info2) {
			...
			if (($customer_info2) && ($this->request->get['customer_id'] != $customer_info2['customer_id'])) {
				$this->error['warning'] = $this->language->get('error_exists');
			}			
		}
